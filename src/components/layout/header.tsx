...
import {
  Menu, Search, Bell, LogOut, Settings, ChevronDown,
...
export function Header() {
  ...
  // Close dropdowns when clicking outside — avoids z-index stacking context conflict
  useEffect(() => {
  ...
  }, [notificationsOpen, userMenuOpen, setNotificationsOpen]);
            ...
            <div className="absolute right-0 top-full mt-1 w-48 bg-popover border border-border rounded shadow-lg z-50 overflow-hidden">
              ...
              <div className="p-1">
                <Link
                  ...
                  className="flex items-center gap-2 px-2.5 py-1.5 text-[13px] rounded hover:bg-accent transition-colors"
                >
